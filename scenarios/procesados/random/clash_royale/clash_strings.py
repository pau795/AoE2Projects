...
# count = 707000
#
# effect_list = [EffectId.CHANGE_OBJECT_NAME, EffectId.CHANGE_OBJECT_DESCRIPTION, EffectId.CHANGE_OBJECT_PLAYER_NAME, EffectId.DISPLAY_INSTRUCTIONS, EffectId.SEND_CHAT]
# msg2id = {}
#
