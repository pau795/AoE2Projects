...
from data_mods.procesados.dynamic_battle3_lan.dynamic_battle3_lan import DynamicBattle3Lan
...
if __name__ == '__main__':
    ...
    output_folder = Path('Dynamic Battle 3 LAN Maps')
    ...
    zip_name = 'Dynamic_Battle_LAN_3_Map_Pack.zip'
    ...
    dynamic_battle_lan_dat = DynamicBattle3Lan(dat_folder)
