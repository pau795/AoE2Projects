...
class EarthquakeMigration(ParserProject):
...
if __name__ == '__main__':
    earthquake = EarthquakeMigration(
        input_scenario_name='EDIT_EARTHQUAKE_MIGRATION_1V1',
        output_scenario_name='EDIT_EARTHQUAKE_MIGRATION_1V1'
    )
    earthquake.convert()
