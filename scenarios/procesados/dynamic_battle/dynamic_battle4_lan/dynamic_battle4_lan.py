...
from data_mods.procesados.dynamic_battle4_lan.dynamic_battle4_lan import DynamicBattle4Lan
...
if __name__ == '__main__':
    ...
    output_folder = Path('Dynamic Battle 4 LAN Maps')
    ...
    zip_name = 'Dynamic_Battle_4_LAN_Map_Pack.zip'
    input_scenario_prefix = 'EDIT_'
    output_scenario_prefix = 'OUTPUT_'
    mod_scenario_prefix = 'DB4L_'
    ...
    dynamic_battle_lan_dat = DynamicBattle4Lan(dat_folder)
